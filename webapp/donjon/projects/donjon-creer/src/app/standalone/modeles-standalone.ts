...
export const NOUVEAU_DJN = `-- "Informations sur le jeu".
...
interpréter croquer comme manger.

Le magazine est un objet dans le salon.
...
Le texte du magazine est "Ils repassent un film de Noël ce soir.".

-- règle: sortie spécifique la 1ère et 2e fois que le joueur prend la pomme.
après prendre la pomme:
