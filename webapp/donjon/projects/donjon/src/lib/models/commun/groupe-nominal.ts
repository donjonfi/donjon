export class GroupeNominal {
   ...
   */
  static readonly xPrepositionDeterminantArticleNomEpithete = /^(?!")(?:(dans|sur|sous|vers) )?(le |la |l(?:’|')|les |un |une |des |du |de la |de l(?:’|')|\d+)?(\S+?|(?:\S+? (?:à |au(?:x)? |en |(?:(?:dans|et|sous|sur|vers) (?:la |le |les |l’|'))|de (?:la |l'|l’)?|du |des |d'|d’)\S+?))(?:(?: )(?!\(|ne |n’|n'|d’|d'|et |un |de )(\S+))?$$/i;
