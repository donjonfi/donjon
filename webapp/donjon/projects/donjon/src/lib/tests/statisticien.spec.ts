...
describe('Statisticien − Extraire textes affichables au joueur', () => {
  ...
  it('[F047-T001] une instruction dire simple', () => {
    const scenario = '' +
  ...
  it('[F047-T002] une instruction dire simple et commentaire', () => {
    const scenario = '' +
      'avant commencer le jeu:\n' +
      '  -- dire "commentaire"\n' +
      '  dire "Bonjour!".';
  ...
  it('[F047-T003] une instruction dire avec une condition', () => {
    const scenario = '' +
      'avant commencer le jeu: ' +
  ...
  it('[F047-T004] une instruction dire avec du style', () => {
    const scenario = '' +
      'avant commencer le jeu: ' +
      '  dire "{+Bonjour !+}".';
    const textes = Statisticien.extraireTextesAffichablesAuJoueurNettoyes(scenario);
  ...
  it('[F047-T005] une instruction dire avec sous texte (à ne pas compatibiliser)', () => {
    const scenario = '' +
      'avant commencer le jeu: ' +
  ...
  it('[F047-T006] une instruction dire avec crochets conditionnels, ponctuation séparée, apostrophe', () => {
    const scenario = '' +
      'avant commencer le jeu: \n' +
      '  dire "L’hôpital". \n' +
...
describe('Statisticien − Nombre de mots scénario', () => {
  ...
  it('[F047-T007] une instruction dire simple', () => {
    const scenario = '' +
      'avant commencer le jeu: ' +
      '  dire "Bonjour".';
  ...
  it('[F047-T008] une instruction dire avec du style', () => {
    const scenario = '' +
      'avant commencer le jeu: ' +
      '  dire "{+Bonjour+}".';
    const statistiques = Statisticien.calculerStatistiquesScenario(scenario);
  ...
  it('[F047-T009] une instruction dire avec crochets conditionnels, ponctuation séparée et apostrophe', () => {
    const scenario = '' +
      'avant commencer le jeu: \n' +
      '  dire "L’hôpital". \n' +
      '  dire "Bon[si il est tard]soir[sinon]jour[fin si] [intitulé ceci]facteur !".';
...
describe('Statisticien − Nombre de mots sortie', () => {
  ...
  it('[F047-T010] une instruction dire simple', () => {
    const sortie =
      '<h5>Nouveau jeu</h5>' +
