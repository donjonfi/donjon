  ...
  phase exécution:
    ...
    si ceci est un objet:
      ...
      si la préposition de ceci est sous:
        dire "[décrire objets sous ceci sauf mentionnés]".
    ...
    fin si
    -- marquer l’élément APRÈS l’avoir décrit : ainsi la 1re description emploie la forme
    -- indéfinie (« C’est un parchemin. ») et les examens suivants la forme définie (« le parchemin »).
...
action regarder:
  phase exécution:
    ...
    si l'infinitif de l'action est examiner:
      dire "{n}[description ici][décrire objets ici sauf mentionnés]".
    sinon
      dire "{n}[description ici][décrire objets ici sauf cachés et mentionnés]".
    fin si.
  phase épilogue:
    dire "{P}[sorties ici]".
fin action
