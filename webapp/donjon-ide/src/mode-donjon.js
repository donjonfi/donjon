...
var DonjonHighlightRules = function() {
    ...
    var keywords = (
        "si|sinon|quand|remplacer|avant|après|" +
        "est|vaut"
    );
    ...
    var dataTypes = (
        "porte|portes|clé|clés|salle|salles|lieu|lieux|décor|décors|contenant|objet|objets|animal|animaux|personne|personnes|nombre"
    );
