...
| `dsl-05-avance.md` | Positions, Routines, Réactions (PNJ), Compteurs, Listes, Temps, `inclure` (multi-fichiers) | PNJ, mémoire, compteurs, temps, découper en plusieurs fichiers |
