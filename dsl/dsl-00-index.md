...
| `dsl-05-avance.md` | Positions, Routines, Réactions (PNJ), Compteurs, Listes, Temps, `inclure` (multi-fichiers), Fonds (décor multi-lieux), Locateur spatial | PNJ, mémoire, compteurs, temps, découper en plusieurs fichiers, décor présent dans plusieurs lieux (ciel/sol/mer), désigner par la position |
